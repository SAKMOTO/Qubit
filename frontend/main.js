...
function launchQubit() {
  ...
  // Use the Homebrew-installed Python 3.11 interpreter, where Qubit's
  // dependencies (including browser-use) are installed.
  // This avoids the older system Python 3.9 that cannot satisfy requirements.
  let pythonExec = '/opt/homebrew/opt/python@3.11/bin/python3.11';
